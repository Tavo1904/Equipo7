...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2026 a las 17:11:06
...
CREATE TABLE `creditos` (
  ...
  `estado` enum('aprobado','suspendido','cancelado') NOT NULL DEFAULT 'aprobado',
...
INSERT INTO `creditos` (`id_credito`, `id_usuario`, `monto_total`, `saldo_disponible`, `estado`, `fecha_autorizacion`, `fecha_solicitud`, `fecha_resolucion`, `observaciones`) VALUES
(1, 4, 2000.00, 1923.00, 'aprobado', '2026-06-04 15:45:51', NULL, NULL, NULL),
(2, 5, 5000.00, 3423.00, 'aprobado', '2026-06-04 15:45:51', NULL, NULL, NULL);
...
INSERT INTO `movimientos_inventario` (`id_movimiento`, `id_producto`, `id_usuario`, `tipo_movimiento`, `cantidad`, `observaciones`, `fecha`) VALUES
(1, 79, 1, 'salida', 2, 'Venta POS Folio #1 (menudeo)', '2026-06-04 16:03:31'),
(2, 79, 1, 'salida', 2, 'Venta POS Folio #2 (menudeo)', '2026-06-04 16:14:32'),
(3, 98, 1, 'salida', 1, 'Venta POS Folio #000003 (menudeo) — $45.00 c/u', '2026-06-05 08:06:34'),
(4, 94, 1, 'salida', 1, 'Venta POS Folio #000003 (menudeo) — $32.00 c/u', '2026-06-05 08:06:34'),
(5, 98, 1, 'salida', 1, 'Venta POS Folio #000004 (menudeo) — $45.00 c/u', '2026-06-05 08:07:14'),
(6, 94, 1, 'salida', 1, 'Venta POS Folio #000004 (menudeo) — $32.00 c/u', '2026-06-05 08:07:14'),
(7, 94, 1, 'salida', 1, 'Venta POS Folio #000005 (menudeo) — $32.00 c/u', '2026-06-05 08:44:47');
...
INSERT INTO `pagos_credito` (`id_pago`, `id_credito`, `monto_pagado`, `observaciones`, `fecha_pago`) VALUES
...
INSERT INTO `pedidos` (`id_pedido`, `id_usuario`, `id_cliente`, `estado`, `tipo_pago`, `total`, `fecha`, `notas_cliente`, `fecha_resolucion`) VALUES
(1, 1, 4, 'completado', 'credito', 76.00, '2026-06-04 16:03:31', NULL, NULL),
(2, 1, NULL, 'completado', 'tarjeta', 76.00, '2026-06-04 16:14:32', NULL, NULL),
(3, 1, 5, 'completado', 'credito', 77.00, '2026-06-05 08:06:34', NULL, NULL),
(4, 1, 4, 'completado', 'credito', 77.00, '2026-06-05 08:07:14', NULL, NULL),
(5, 1, NULL, 'completado', 'efectivo', 32.00, '2026-06-05 08:44:47', NULL, NULL);
...
(1, 'Paracetamol 500mg', 'Paracetamol', NULL, 'Analgésico', 'Genérico', 'Tabletas c/20', '2027-06-01', 25.00, 20.00, 12.00, 100, 10, NULL, 'disponible', '2026-06-04 15:52:08'),
...
(64, 'Ambroxol 30mg', 'Ambroxol clorhidrato', 'RES-006', 'Respiratorios', 'Boehringer', 'Frasco 120ml jarabe', '2027-02-28', 72.00, 57.00, 36.00, 75, 10, NULL, 'disponible', '2026-06-04 15:58:58'),
...
(79, 'Ácido Fólico 5mg', 'Ácido fólico', 'VIT-005', 'Vitaminas', 'Genérico MX', 'Caja 30 tabletas', '2027-02-28', 38.00, 30.00, 19.00, 126, 15, NULL, 'disponible', '2026-06-04 15:58:58'),
...
(94, 'Albendazol 400mg', 'Albendazol', 'PAR-001', 'Antiparasitarios', 'GSK', 'Caja 1 tableta', '2027-06-30', 32.00, 25.00, 16.00, 117, 15, NULL, 'disponible', '2026-06-04 15:58:58'),
...
(99, 'Agua Oxigenada 3%', 'Peróxido de hidrógeno', 'CUR-002', 'Material de curación', 'Genérico MX', 'Frasco 250ml', '2028-01-31', 22.00, 17.00, 11.00, 180, 20, NULL, 'disponible', '2026-06-04 15:58:58'),
...
INSERT INTO `proveedores` (`id_proveedor`, `nombre`, `rfc`, `telefono`, `productos`, `fecha_registro`) VALUES
(1, 'Distribuidora Médica del Sureste', 'DMS800415JK2', '2299101520', 'Analgésicos, antibióticos, antiinflamatorios, material de curación', '2026-06-04 15:45:51'),
(2, 'Farmacéutica Nacional FANASA', 'FNA750920AB8', '5556781234', 'Cardiovasculares, diabetes, neurológicos, vitaminas y suplementos', '2026-06-04 15:45:51'),
(3, 'Probiomed Distribuciones', 'PDI901105RT4', '5543219876', 'Respiratorios, dermatológicos, oftálmicos, antiparasitarios', '2026-06-04 15:45:51'),
(4, 'Grupo Quimsa Salud', 'GQS850630MN3', '2228763300', 'Gastrointestinales, insulinas, inhaladores, material de curación', '2026-06-04 15:45:51');
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `correo`, `contraseña`, `rol`, `estado`, `rfc`, `tipo_cliente`, `limite_mayoreo`, `intentos_fallidos`, `bloqueado_hasta`, `fecha_registro`) VALUES
(1, 'Administrador', 'admin@farmacia.com', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', 'admin', 'activo', NULL, 'minorista', 50, 0, NULL, '2026-06-04 15:45:28'),
(2, 'Elizabeth Ramírez Torres', 'elizabeth.ramirez@farmacia.com', '$2y$10$7t1N1mKVl4VlLqBqL2sOUe0Zq3Gik8sBWfp9RsYcMxRJEqVk9L.26', 'empleado', 'activo', NULL, 'minorista', 50, 0, NULL, '2026-06-04 15:45:51'),
(3, 'Jesús Hernández Mendoza', 'jesus.hernandez@farmacia.com', '$2y$10$7t1N1mKVl4VlLqBqL2sOUe0Zq3Gik8sBWfp9RsYcMxRJEqVk9L.26', 'empleado', 'activo', NULL, 'minorista', 50, 0, NULL, '2026-06-04 15:45:51'),
(4, 'María Guadalupe Sánchez López', 'guadalupe.sanchez@gmail.com', '$2y$10$PX3pFqnTqFMjZyJMpHgY7uXQbLY8XNmVrJi1w4UGkOT0aWrPE7VQi', 'cliente', 'activo', 'SALG850712HV8', 'minorista', 50, 0, NULL, '2026-06-04 15:45:51'),
(5, 'Roberto Carlos Flores Vega', 'roberto.flores@gmail.com', '$2y$10$PX3pFqnTqFMjZyJMpHgY7uXQbLY8XNmVrJi1w4UGkOT0aWrPE7VQi', 'cliente', 'activo', 'FOVR780320QT5', 'mayorista', 100, 0, NULL, '2026-06-04 15:45:51');
